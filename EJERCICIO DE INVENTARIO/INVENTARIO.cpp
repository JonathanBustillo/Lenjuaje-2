...
void ajusteDeInventarPositivo() {
    string codigo = "";
    int cantidad = 0;

    system("cls");
    cout << endl;
    cout << "Ajuste de Productos al Inventario" << endl;
    cout << "**********************************" << endl;
    cout << "Ingrese el codigo del producto: ";
    cin >> codigo;
    cout << endl;
...
int main(int argc, char const *argv[])
{
    ...
    while(true) {
        ...
        cout << "4 - Ajuste de Inventario Positivo " << endl;
        cout << "5 - Ajuste de Inventario Negativo" << endl;
        cout << "0 - Salir" << endl;
